!(function (e) {
  ...
  var a,
    ...
    d = ".appointment-form",
    u = e(d).find(".form-messages");
  function p(t, s, a, n, o) {
    var i,
      r = e(t).serialize();
    (i = (function (t, s, a, n) {
      var o,
      ...
      r(t),
        ...
        e(s)
          .val()
          .match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/)
          ? (e(s).removeClass(a), (i = !0))
          : (e(s).addClass(a), (i = !1));
      return i;
    })(s, a, n, t)),
      i &&
        jQuery
          .ajax({ url: e(t).attr("action"), data: r, type: "POST" })
          .done(function (s) {
            o.removeClass("error"),
              o.addClass("success"),
              o.text(s),
              e(t + ' input:not([type="submit"]),' + t + " textarea").val("");
          })
          .fail(function (e) {
  ...
  e(i).on("submit", function (e) {
    ...
    e(d).on("submit", function (e) {
      e.preventDefault(),
        p(
          d,
          '[name="name"],[name="email"],[name="subject"],[name="number"],[name="date"]',
          l,
          r,
          u
        );
